...
RSpec.describe WeeklyShift, type: :model do
  describe 'validations' do
    ...
    it { should belong_to(:weekly_roster) }
  end
  ...
  describe 'time validation' do
    ...
    let(:valid_shift) { build(:weekly_shift, weekly_roster: weekly_roster, start_time: '08:00', end_time: '16:00') }
    let(:invalid_shift) { build(:weekly_shift, weekly_roster: weekly_roster, start_time: '16:00', end_time: '08:00') }
